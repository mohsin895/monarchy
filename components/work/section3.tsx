...
export default function WorkSectionThird() {
  return (
    <section className="relative w-full bg-black text-gray-200 font-sans py-20 px-6 overflow-hidden">
      <div className="max-w-5xl mx-auto text-center space-y-6">
        ...
        {/* ----- FAQ CARDS ----- */}
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 justify-center">

  {/* Card 1 */}
  <div className="bg-black border border-[#202020] hover:border-purple-500/60 rounded-xl p-6 transition text-left">
    <h3 className="text-lg font-semibold text-[#917EE0] mb-3">
  ...
  {/* Card 4 */}
  <div className="bg-black border border-[#202020] hover:border-purple-500/60 rounded-xl p-6 transition text-left">
    <h3 className="text-lg font-semibold text-[#917EE0] mb-3">How does it work?</h3>
    <p className="text-gray-400 text-sm leading-relaxed">
  ...
  {/* Card 5 */}
  <div className="bg-black border border-[#202020] hover:border-purple-500/60 rounded-xl p-6 transition text-left sm:col-span-2 lg:col-span-2 max-w-md mx-auto">
    <h3 className="text-lg font-semibold text-[#917EE0] mb-3">
