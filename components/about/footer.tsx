...
export default function AboutFooter() {
  return (
    <section className="relative bg-black text-white pt-4  flex flex-col items-center justify-center ">
      
      {/* Floating image container */}
      <div className="relative w-[300px] md:w-[245px] mb-1 flex flex-col items-center">
